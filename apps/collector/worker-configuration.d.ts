/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 50149d9ef73f60e57b9586a91a767351)
...
declare namespace Cloudflare {
	...
	interface Env {
		BACKLOG_BUCKET: R2Bucket;
		INGEST_URL: "http://host.docker.internal:8080/ingest" | "https://api.trackyapp.net/ingest";
		METRA_API_KEY: string;
		CTA_BUS_API_KEY: string;
		CTA_TRAIN_API_KEY: string;
		COLLECTOR_CONTAINER: DurableObjectNamespace<import("./src/index").CollectorContainer>;
