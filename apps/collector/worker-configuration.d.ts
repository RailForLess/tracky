/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8e66977880d59c09ebb10864e7712a2f)
// Runtime types generated with workerd@1.20260430.1 2026-05-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CollectorContainer";
	}
	interface ProductionEnv {
		BACKLOG_BUCKET: R2Bucket;
		INGEST_URL: "https://api.trackyapp.net/ingest";
		METRA_API_KEY: string;
		CTA_BUS_API_KEY: string;
		CTA_TRAIN_API_KEY: string;
		COLLECTOR_CONTAINER: DurableObjectNamespace<import("./src/index").CollectorContainer>;
	}
	interface Env {
		BACKLOG_BUCKET: R2Bucket;
		INGEST_URL: "https://api.trackyapp.net/ingest" | "http://host.docker.internal:8080/ingest";
		METRA_API_KEY: string;
		CTA_BUS_API_KEY: string;
		CTA_TRAIN_API_KEY: string;
		COLLECTOR_CONTAINER: DurableObjectNamespace<import("./src/index").CollectorContainer>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INGEST_URL" | "METRA_API_KEY" | "CTA_BUS_API_KEY" | "CTA_TRAIN_API_KEY">> {}
}
