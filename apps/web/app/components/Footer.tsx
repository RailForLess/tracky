      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="border-t border-black/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5">
            <a href="https://discord.gg/PqYt7NJvcp" target="_blank" rel="noopener noreferrer" className="text-black/20 hover:text-black transition-colors" aria-label="Discord">
            ...
            <a href="https://github.com/RailForLess/tracky" target="_blank" rel="noopener noreferrer" className="text-black/20 hover:text-black transition-colors" aria-label="GitHub">
            ...
            <a href="mailto:him@jasonxu.me?subject=Tracky" className="text-black/20 hover:text-black transition-colors" aria-label="Email">
