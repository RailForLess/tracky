...
export function Header({ introStage, headerCompact }: { introStage: number; headerCompact: boolean }) {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/RailForLess/tracky")
      .then(r => r.json())
    ...
    <header className="fixed top-0 left-1/2 z-50" style={{
      ...
      <div className="flex items-center justify-between px-5 h-12">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <a href="https://github.com/RailForLess/tracky" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-white border border-black/10 text-black/30 text-xs font-semibold transition-all hover:bg-black/5">
